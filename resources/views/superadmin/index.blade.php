            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <!-- Data Karyawan -->
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('superadmin.karyawan.index') ? 'active' : '' }}"
                                href="{{ route('superadmin.karyawan.index') }}">
                                <span class="nav-icon">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-people"
                                        fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M5.216 14A2.238 2.238 0 0 1 3 11.784V10a4 4 0 1 1 8 0v1.784A2.238 2.238 0 0 1 10.784 14H5.216z" />
                                        <path fill-rule="evenodd" d="M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z" />
                                    </svg>
                                </span>
                        ...
                        <li class="nav-item has-submenu">
                            <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse"
                                data-bs-target="#submenu-pengajuan" aria-expanded="false"
                                aria-controls="submenu-pengajuan">
                                <span class="nav-icon">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-text"
                                        fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                                            d="M4 1a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V5.5L9.5 1H4zm8 11H4v-1h8v1zm0-2H4V9h8v1zm0-2H4V7h8v1zm-3-4V2.5L12.5 5H9a1 1 0 0 1-1-1z" />
                                    </svg>
                                </span>
                            ...
                            <div id="submenu-pengajuan" class="collapse submenu" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    <li class="submenu-item"><a
                                            class="submenu-link {{ request()->routeIs('superadmin.pengajuan.cuti') ? 'active' : '' }}"
                                            href="{{ route('superadmin.pengajuan.cuti') }}">Cuti</a></li>
                                    <li class="submenu-item"><a
                                            class="submenu-link {{ request()->routeIs('superadmin.pengajuan.lembur') ? 'active' : '' }}"
                                            href="{{ route('superadmin.pengajuan.lembur') }}">Lembur</a></li>
                                    <li class="submenu-item"><a
                                            class="submenu-link {{ request()->routeIs('superadmin.pengajuan.sakit') ? 'active' : '' }}"
                                            href="{{ route('superadmin.pengajuan.sakit') }}">Sakit</a></li>
                                </ul>
                            </div>
                        </li>
                            ...
                            <a class="nav-link" href="{{ route('superadmin.settings') }}">
                                <span class="nav-icon">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-gear"
                                        ...
                                        <path fill-rule="evenodd"
                                            d="M8 0a8 8 0 0 0-7.466 4.757L0 5l1 1 1-1h12l1 1-1-1-.534-.243A8 8 0 0 0 8 0z" />
                                    </svg>
                                </span>
